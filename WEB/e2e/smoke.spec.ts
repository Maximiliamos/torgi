...
test("authenticated list search detail and API failure smoke", async ({
  ...
  // Yandex-object selection, viewport preservation, review propagation, and
  // coincident-lot behavior have deterministic MapView component coverage.
  // The dedicated production-map E2E owns the public S3/Yandex transport.
  await page.screenshot({
