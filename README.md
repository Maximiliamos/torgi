...
Мировой масштаб ограничен динамическим минимальным zoom без циклического
повторения тайлов; для Яндекс-карты не используется конфликтующее с её мировой
проекцией ограничение `restrictMapArea`.
Если API Яндекс.Карт создал контейнер, но не загрузил ни одного тайла (например,
из-за отклонённого API-ключа), вкладка автоматически включает локально собранную
Leaflet-карту вместо чёрного фона.
