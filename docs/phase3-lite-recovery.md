...
`[Phase 3] Source health warning` covers per-source freshness or full-coverage degradation while production itself remains available. This warning is deduplicated and closes automatically when the source checks recover.
